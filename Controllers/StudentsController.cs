...
namespace SchoolManagement.Controllers
{
    public class StudentsController : Controller
    {
        ...
        {
            ViewBag.StudentId = new SelectList(db.StudentAddresses, "StudentAddressId", "Address");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "StudentId,StudentName")] Student student)
        {
            ...
            ViewBag.StudentId = new SelectList(db.StudentAddresses, "StudentAddressId", "Address", student.StudentId);
            return View(student);
        }
